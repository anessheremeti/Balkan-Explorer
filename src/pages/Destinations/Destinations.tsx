  ...
  const destinations = [
    {
      ...
      rating: 4.8,
      places_count: 42,
      descKey: 'dest_card_sarande_desc',
    },
    {
      id: '2',
      name: 'Kotor',
    ...
    },
    {
      ...
      rating: 4.6,
      places_count: 24,
      descKey: 'dest_card_prizren_desc',
    },
    {
      id: '5',
      name: 'Gjirokastër',
      ...
      rating: 4.7,
      places_count: 19,
      descKey: 'dest_card_gjirokaster_desc',
    },
    {
      id: '6',
      name: 'Budva',
      ...
      <div className="relative h-100 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <motion.p
            ...
            className={`text-xl  ${isDark ? 'text-slate-900' : 'text-slate-700' } text-slate-700 mb-10 max-w-2xl mx-auto leading-relaxed`}
          >
            {t('dest_subtitle')}
          </motion.p>
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <div className="text-xs font-bold text-[#0ea5e9] bg-[#0ea5e9]/10 px-2.5 py-1 rounded-lg">
                    {dest.places_count} {t('dest_card_places')}
                  </div>
                </div>
